...
import { MessageSquare, X, Send, Sparkles } from '../ui/Icons';
...
const ChatAssistant: React.FC = () => {
  ...
  const chatSession = useRef<any>(createChatSession());
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const text = result?.text ?? "I didn't get a response. Please try again.";
